                ...
                {topPerformers.length > 0 && (
                  <Card className="glassmorphic-card"> {/* Applied consistent card style */}
                    <CardHeader className="p-4 sm:p-5 lg:p-6 pb-2"> {/* Applied consistent padding */}
                      <CardTitle className="text-base sm:text-lg font-semibold tracking-tight">{t("dashboard.topPerformers")}</CardTitle> {/* Applied consistent typography */}
                    </CardHeader>
                    <CardContent className="space-y-3 p-4 sm:p-5 lg:p-6 pt-0 divide-y divide-border/10"> {/* Applied consistent padding and divider */}
